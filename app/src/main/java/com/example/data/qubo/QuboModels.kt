...
sealed class Constraint {
    ...
    data class MutualExclusion(
        val rules: List<Int>,
        override val description: String = ""
    ) : Constraint()

    data class AtLeastOneOf(
        val rules: List<Int>,
        override val description: String = ""
    ) : Constraint()
}
...
data class EngineConfig(
    ...
    val initialTemperature: Double = 100.0,
    val minTemperature: Double = 0.001,
    val coolingRate: Double = 0.995,
    val penaltyWeight: Double = 1000.0,
...
data class EvolutionEvent(
    ...
    val site: Int,
    val proposed: String, // "ACTIVATE" or "DEACTIVATE"
...
data class QuboSolution(
    ...
    val activeRules: List<PolicyRule>,
    val inactiveRules: List<PolicyRule>,
    val totalCost: Double,
    val totalRiskReduction: Double,
    val totalBusinessValue: Double,
    val quboEnergy: Double,
    val activeCount: Int,
...
data class CounterfactualResult(
    val originalSolution: QuboSolution,
    val alteredSolution: QuboSolution,
    val diverges: Boolean,
    val costDelta: Double,
    val riskDelta: Double,
    val valueDelta: Double,
    val rulesChanged: List<String>
)

data class IsingModel(
    val J: List<List<Double>>,
    val h: List<Double>,
    val offset: Double
)
